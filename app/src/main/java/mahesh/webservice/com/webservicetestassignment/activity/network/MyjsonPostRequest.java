...
public class MyjsonPostRequest extends JsonRequest<JSONObject> {
     ...
     * @param errorListener Error listener, or null to ignore errors.
     */
    public MyjsonPostRequest(String url, Listener<JSONObject> listener, ErrorListener errorListener) {
     ...
     * @param errorListener Error listener, or null to ignore errors.
     */
    public MyjsonPostRequest(int method, String url, Listener<JSONObject> listener, ErrorListener errorListener) {
     ...
     */
    public MyjsonPostRequest(String url, JSONArray jsonRequest, Listener<JSONObject> listener,
     ...
     */
    public MyjsonPostRequest(String url, JSONObject jsonRequest, Listener<JSONObject> listener,
                             ErrorListener errorListener) {
        this(jsonRequest == null ? Method.GET : Method.POST, url, jsonRequest,
                listener, errorListener);
    }
